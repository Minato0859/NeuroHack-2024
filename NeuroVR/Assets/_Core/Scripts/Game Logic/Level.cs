...
namespace GorillaZilla
{
    public class Level : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            virusRoot = new GameObject("Virus").transform;
            virusRoot.parent = transform;
        ...
        //     print("Virus destroyed, remaining: " + spawnedEnemies.Count);
        ...
        public void ClearLevel()
        {
            ...
            virusRoot.gameObject.DestroyChildren();
